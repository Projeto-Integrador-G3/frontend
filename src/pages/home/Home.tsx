...
const CardProduto = ({ imgUrl, nomeProduto, descricao }) => {
    return (
        <div className="flex-shrink-0   md:w-1/2 lg:w-1/3 xl:w-1/4 mb-8">
...
function Home() {
    return (
        <>
                ...
                <div className="container h-screen mx-auto mt-8 p-8 bg-white rounded-lg  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                    <div>
                    ...
                    <div className="container justify-betwwen w-full mx-auto mt-8 flex  gap-5">
                        <CardProduto
