            ...
            <div className='min-h-screen '>
                <div className='px-8 md:px-[100px] md:pt-[100px]'>
                    <div className='flex flex-col md:flex-row items-center'>
                        <img className='rounded-full md:size-[34rem]' src="https://ik.imagekit.io/zcioxdl6o/20240131_180617_0000.png_ex=65cd2b56&is=65bab656&hm=1c201f4058f5f2d0ca8aafe8b224037b0ae0eb69773e1625c357aaa4d5d2ceb0&?updatedAt=1706882303135"
                            alt="logo Uni" />
